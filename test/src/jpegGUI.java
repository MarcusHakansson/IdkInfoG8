...
public class jpegGUI extends JFrame {
	...
	public jpegGUI() {
		...
		PromptSupport.setPrompt("VÃ¤lj en bild", uploadField);
		
		JLabel lblNewLabel = new JLabel(" VÃ¤lj bild frÃ¥n din dator:");
		...
		JButton rubrikBtn = new JButton("LÃ¤gg till");
		...
		JButton datumTidBtn = new JButton("LÃ¤gg till");
		...
		JButton platsBtn = new JButton("LÃ¤gg till");
		...
		JButton infoBtn = new JButton("LÃ¤gg till");
		...
		JLabel lblFrhandsgrandska = new JLabel("FÃ¶rhandsgrandska\n");
